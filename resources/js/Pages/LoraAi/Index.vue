        ...
        <div class="pms-settings-shell mx-auto w-full max-w-[1480px]">
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            <div class="mb-1 flex items-center gap-2">
                                <h2 data-ui="card-title">ChatGPT për {{ connection.hotel }}</h2>
                            ...
                            <p data-ui="card-copy" class="max-w-2xl text-neutral-500">ChatGPT kërkon në modulet që lejon ti, kthen linkun e rekordit burim dhe krahason çmimin live me motorin Lora, tregun dhe rekomandimin e vet. Çdo lidhje izolohet vetëm te ky hotel.</p>
                        </div>
                    </div>
            ...
            <section class="grid gap-4 xl:grid-cols-[minmax(0,1fr)_420px]">
                <div data-ui="card" class="settings-card-pad border border-neutral-200 bg-white">
                    <div class="flex items-start justify-between gap-4">
                        <div>
                            <div class="flex items-center gap-2 text-neutral-900"><Search class="h-4 w-4 text-primary-700" /><h2 data-ui="card-title">Pyetje të shpejta për ChatGPT</h2></div>
                            <p data-ui="card-copy" class="mt-1 text-neutral-500">Kopjo një pyetje ose shkruaje natyrshëm në ChatGPT. Rezultatet përfshijnë linkun drejt rekordit në Lora.</p>
                        </div>
                ...
                <div data-ui="card" class="settings-card-pad border border-neutral-200 bg-white">
                    <div class="flex items-center gap-2 text-neutral-900"><Sparkles class="h-4 w-4 text-amber-600" /><h2 data-ui="card-title">Çmimi hibrid</h2></div>
                    <p data-ui="card-copy" class="mt-1 text-neutral-500">Një vendim, katër burime të ndara qartë.</p>
                    <div class="mt-4 space-y-2">
                        <div data-ui="compact-row" class="flex items-center justify-between bg-neutral-50"><span class="text-neutral-500">Çmimi live</span><b class="text-neutral-800">Shitet tani</b></div>
                        <div data-ui="compact-row" class="flex items-center justify-between bg-blue-50"><span class="text-blue-700">Motori Lora</span><b class="text-blue-900">Determinist</b></div>
                        <div data-ui="compact-row" class="flex items-center justify-between bg-violet-50"><span class="text-violet-700">ChatGPT</span><b class="text-violet-900">Alternativë + arsye</b></div>
                        <div data-ui="compact-row" class="flex items-center justify-between bg-amber-50"><span class="text-amber-700">Tregu</span><b class="text-amber-900">Kur ka të dhëna</b></div>
                    </div>
            ...
            <div class="grid gap-4 xl:grid-cols-[minmax(0,1fr)_360px]">
                <form class="space-y-4" @submit.prevent="save">
                    <section data-ui="card" class="border border-neutral-200 bg-white">
                        <div data-ui="card-header" class="border-b border-neutral-200">
                            <div class="flex items-center justify-between gap-4">
                                <div><h2>Të dhënat dhe kërkimi universal</h2><p>Aktivizo vetëm modulet që ChatGPT duhet të kërkojë. Dokumentet e identitetit dhe kartat nuk ekspozohen.</p></div>
                    ...
                    <section data-ui="card" class="border border-neutral-200 bg-white">
                        <div data-ui="card-header" class="border-b border-neutral-200">
                            <h2>Veprime të mbrojtura</h2>
                            <p>ChatGPT përgatit parapamjen; përdoruesi duhet ta konfirmojë para ekzekutimit.</p>
                        </div>
                        ...
                        <div data-ui="card-footer" class="settings-sticky-footer border-t border-neutral-200">
                            ...
                            <button data-ui="button" type="submit" :disabled="form.processing" class="bg-primary-700 px-5 text-white hover:bg-primary-800 disabled:opacity-50">{{ form.processing ? 'Duke ruajtur…' : 'Ruaj lejet' }}</button>
                        </div>
                    </section>
                </form>
                ...
                <aside class="space-y-4">
                    <section data-ui="card" class="settings-card-pad border border-neutral-200 bg-white">
                        <h3 data-ui="card-title">Si lidhet</h3>
                    ...
                    <section data-ui="card" class="settings-card-pad border border-neutral-200 bg-white">
                        <h3 data-ui="card-title">Aktiviteti i fundit AI</h3>
