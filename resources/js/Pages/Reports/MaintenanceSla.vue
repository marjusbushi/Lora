...
const kpis = computed(() => [
    { label: translate('reports360.maintenanceSla.reported'), help: translate('reports360.help.msReported'), value: summary.value.reported || 0, tone: 'neutral', icon: Wrench, detail: `${summary.value.open || 0} ${translate('reports360.maintenanceSla.open')}` },
    { label: translate('reports360.maintenanceSla.slaRate'), help: translate('reports360.help.msSlaRate'), value: pct(summary.value.sla_rate), tone: Number(summary.value.sla_rate || 0) >= 90 ? 'success' : 'warning', icon: CircleCheckBig },
    { label: translate('reports360.maintenanceSla.resolutionTime'), help: translate('reports360.help.msResolutionTime'), value: hours(summary.value.avg_resolution_hours), tone: 'info', icon: Clock3, detail: `${summary.value.overdue || 0} ${translate('reports360.maintenanceSla.overdue')}` },
    { label: translate('reports360.maintenanceSla.downtime'), help: translate('reports360.help.msDowntime'), value: hours(summary.value.downtime_hours), tone: 'error', icon: AlarmClock, detail: `${summary.value.affected_rooms || 0} ${translate('reports360.maintenanceSla.rooms')}` },
]);
