...
const kpis = computed(() => [
    { label: translate('reports360.recurringMaintenance.patterns'), help: translate('reports360.help.rmPatterns'), value: number(summary.value.recurring_groups), tone: 'warning', icon: Repeat2, detail: `${number(summary.value.repeat_occurrences)} ${translate('reports360.recurringMaintenance.repeats')}` },
    { label: translate('reports360.recurringMaintenance.repeatRate'), help: translate('reports360.help.rmRepeatRate'), value: pct(summary.value.repeat_rate), tone: Number(summary.value.repeat_rate || 0) > 20 ? 'error' : 'neutral', icon: AlertTriangle },
    { label: translate('reports360.recurringMaintenance.avgInterval'), help: translate('reports360.help.rmAvgInterval'), value: days(summary.value.avg_interval_days), tone: 'info', icon: Clock3 },
