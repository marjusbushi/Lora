...
class AuditTimeline
{
    private const ACTION_LABELS = [
        ...
        'reservation.early_departure_scheduled' => 'U planifikua largim i parakohshëm',
        'reservation.early_departure_plan_cancelled' => 'U anulua plani i largimit të parakohshëm',
        ...
        'payment.refund' => 'U regjistrua rimbursim',
    ...
    private const DETAIL_LABELS = [
        ...
        'to' => 'Në',
        'context' => 'Konteksti',
        'scheduled_check_out' => 'Check-out i planifikuar',
        'original_check_out' => 'Check-out fillestar',
        'planned_check_out' => 'Largimi i planifikuar',
        'restored_check_out' => 'Check-out i rikthyer',
        'new_check_out' => 'Check-out i ri',
        'actual_check_out' => 'Check-out real',
        'additional_nights' => 'Net shtesë',
        'quoted_extension' => 'Çmimi i sugjeruar për shtesën',
        'agreed_extension' => 'Çmimi i rënë dakord për shtesën',
        'original_room_total' => 'Totali fillestar i akomodimit',
        'restored_room_total' => 'Totali i rikthyer i akomodimit',
        'adjusted_room_total' => 'Totali i ri i akomodimit',
        'inventory_released' => 'Netët u liruan në kanale',
        'inventory_reserved' => 'Netët u bllokuan në kanale',
        'ota_contract_unchanged' => 'Kontrata OTA mbeti e pandryshuar',
        'extended_by' => 'Zgjatur nga',
        'policy' => 'Politika',
        'penalty_amount' => 'Penaliteti',
        'reason' => 'Arsyeja',
